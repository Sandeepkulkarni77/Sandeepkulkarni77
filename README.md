...
<title>Sandeep Kulkarni | GitHub Profile</title>
<link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@500;700;900&family=Share+Tech+Mono&display=swap" rel="stylesheet"/>
<style>
*{margin:0;padding:0;box-sizing:border-box;}
body{background:#020408;font-family:'Share Tech Mono',monospace;color:#cdd9e5;min-height:100vh;}
...
.page{position:relative;z-index:2;max-width:700px;margin:0 auto;padding:24px 16px;}
...
.name{font-family:'Orbitron',sans-serif;font-size:22px;font-weight:900;text-align:center;min-height:36px;letter-spacing:.04em;color:#00ff88;text-shadow:none;-webkit-text-stroke:0;}
